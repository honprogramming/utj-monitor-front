define(
    ...
    function ($, oj, ko, RESTConfig, RoutesWrapper, GeneralViewModel, IndicatorUtils) {
      var theKey = {};
      ...
      function MECASUTIndicatorsViewModel() {
        ...
        self.getJson = function (node, fn) {
          ...
          let mecasutPath = version 
            ? `${RESTConfig.admin.data.backups.path}/${version}/MECASUT_GRAPHICS`
            : RESTConfig.indicators.mecasut.tree.path;
