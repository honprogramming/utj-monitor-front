define(
    ...
    function ($, ko, DataProvider, Authorization, RESTConfig, AjaxUtils, GeneralViewModel,
                ...
                () => {
                  AjaxUtils.ajax(
                    ...
                    () => {
                      ...
                      self.showDialog("save-dialog-success");
                      deletedIds = [];
                      cloneItems = [];
                    },
                    (jqXHR, textStatus, errMsg) => {
                      self.saveMessage(`${GeneralViewModel.nls("admin.strategic.saveDialog.error")} ${jqXHR.responseText}`);
