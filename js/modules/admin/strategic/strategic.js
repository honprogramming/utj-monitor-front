define(
    ...
    function ($, ko, DataProvider, RESTConfig, AjaxUtils, RoutesWrapper, GeneralViewModel,
      ...
      function StrategicViewModel() {
        ...
        const clickOkHandlerObservable = ko.observable();

        self.clickOkHandler = function () {
          const handler = clickOkHandlerObservable();
          handler();
        };
        ...
        const strategicTypesDataProvider =
            new DataProvider(
                RESTConfig.admin.strategic.types.path,
                StrategicTypesParser);

        const typesPromise = strategicTypesDataProvider.fetchData();

        const typesSetPromise = typesPromise.then(
            function () {
          ...
          self.axesTable = new EditableTable(strategicModel,
              {
                ...
                filterFunction: () => {
                  return strategicModel.getItemsByType(StrategicTypes.AXE);
                }
              }
          );
          ...
          self.topicsTable = new EditableTable(strategicModel,
              {
                ...
                itemRemover: removeItem,
                filterFunction: () => {
                  return strategicModel.getItemsByType(StrategicTypes.TOPIC);
                }
              }
          );
          ...
          self.objectivesTable = new EditableTable(strategicModel,
              {
                ...
                itemRemover: removeItem,
                filterFunction: () => {
                  return strategicModel.getItemsByType(StrategicTypes.OBJECTIVE);
                }
              }
          );
          ...
          self.strategiesTable = new EditableTable(strategicModel,
              {
                ...
                itemRemover: removeItem,
                filterFunction: () => {
                  return strategicModel.getItemsByType(StrategicTypes.STRATEGY);
                }
              }
          );
