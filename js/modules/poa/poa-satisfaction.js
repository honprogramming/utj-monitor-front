define(
        ...
        function ($, oj, ko, DataProvider, PIDEModel, PIDEDataParser, GeneralViewModel) {
            var theKey = {};
            
            function POASatisfactionViewModel() {
                var self = this;
                ...
                dataPromise.then(
                        function () {
                            self.setControlPanelModel(theKey, new PIDEModel(controlPanelDataProvider));
                            self.detailsData(
                                    {
                                        name: 'poa/poa-satisfaction-details',
                                        params: {
                                            model: self.getControlPanelModel(theKey),
                ...
                var privateData = {
                    ...
                    selectingNode: false,
                    controlPanelModel: undefined,
                    detailsView: undefined
                };
                
                this.POASatisfactionViewModel_ = function(key) {
                    if(theKey === key) {
                        return privateData;
                    }
                };
...
//                };
            ...
            var prototype = POASatisfactionViewModel.prototype;
            
            prototype.setSelectingNode = function(key, selectingNode) {
                if (theKey === key) {
                    this.POASatisfactionViewModel_(key).selectingNode = selectingNode;
                }
            };
            
            prototype.getSelectingNode = function() {
                return this.POASatisfactionViewModel_(theKey).selectingNode;
            };
            ...
            prototype.setSelection = function(key, node) {
                if (theKey === key) {
                    this.POASatisfactionViewModel_(key).selectedNode = node;
                }
            };
            
            prototype.removeSelection = function(key) {
                if (theKey === key) {
                    this.POASatisfactionViewModel_(key).selectedNode = null;
                }
            };
            
            prototype.getSelectedNode = function(key) {
                if (theKey === key) {
                    return this.POASatisfactionViewModel_(key).selectedNode;
                }
            };
            
            prototype.setControlPanelModel = function(key, model) {
                if (theKey === key) {
                    this.POASatisfactionViewModel_(key).controlPanelModel = model;
                }
            };
            
            prototype.getControlPanelModel = function(key) {
                if (theKey === key) {
                    return this.POASatisfactionViewModel_(key).controlPanelModel;
                }
            };
            ...
            prototype.setView = function(key, view) {
                if (theKey === key) {
                    this.POASatisfactionViewModel_(key).detailsView = view;
                }
            };
            
            prototype.getView = function(key, view) {
                if (theKey === key) {
                    return this.POASatisfactionViewModel_(key).detailsView;
                }
            };
            
            return POASatisfactionViewModel;
        }
);