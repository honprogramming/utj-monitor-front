define(
    ...
    function($, oj, ko, GeneralViewModel) {
        ...
        function POAIndicatorsViewModel() {
            var self = this;
            ...
            this.POAIndicatorsViewModel_ = function(key) {
                if(theKey === key) {
                    return privateData;
                }
            };
            ...
            self.filterSearchText = GeneralViewModel.nls("poa.filterSearchText");//2
            self.filterSearchPlaceholder = GeneralViewModel.nls("poa.filterSearchPlaceholder");//3
            ...
            self.title = GeneralViewModel.nls("poa.title");//1
...
//                );
            ...
            self.getJson = function (node, fn) {//8
                $.getJSON("data/poa-process-and-projects.json").then(
                        function (data) {
                            model = data;
        ...
        var prototype = POAIndicatorsViewModel.prototype;
            
        prototype.setSelectingNode = function(key, selectingNode) {
            if (theKey === key) {
                this.POAIndicatorsViewModel_(key).selectingNode = selectingNode;
            }
        };

        prototype.getSelectingNode = function() {
            return this.POAIndicatorsViewModel_(theKey).selectingNode;
        };

        prototype.setHoverNode = function(key, hoverNode) {
            if (theKey === key) {
                this.POAIndicatorsViewModel_(key).hoverNode = hoverNode;
            }
        };

        prototype.getHoverNode = function() {
            return this.POAIndicatorsViewModel_(theKey).hoverNode;
        };
        ...
        prototype.setSelectedNodes = function(key, selectedNodes) {
            if (theKey === key) {
                this.POAIndicatorsViewModel_(key).selectedNodes = selectedNodes;
            }
        };

        prototype.getSelectedNodes = function(key) {
            if (theKey === key) {
                return this.POAIndicatorsViewModel_(key).selectedNodes;
            }
        };

        prototype.setSelectedNodesBackup = function(key, selectedNodesBackup) {
            if (theKey === key) {
                this.POAIndicatorsViewModel_(key).selectedNodesBackup = selectedNodesBackup;
            }
        };

        prototype.getSelectedNodesBackup = function(key) {
            if (theKey === key) {
                return this.POAIndicatorsViewModel_(key).selectedNodesBackup;
            }
        };
